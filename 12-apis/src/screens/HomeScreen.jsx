...
import { Avatar, Card, Text, IconButton, ActivityIndicator, MD2Colors } from "react-native-paper";
...
export default function HomeScreen({ navigation, route }) {
  ...
  // Fazer algo quando o usuário entrar na tela. (Quando o componente for montado)
  useEffect(() => {
    // Tudo que eu quero fazer quando o usuário entrar na tela vai aqui dentro.
